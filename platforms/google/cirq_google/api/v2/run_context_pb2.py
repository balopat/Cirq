...
# source: platforms/google/cirq_google/api/v2/run_context.proto
...
RunContext = _reflection.GeneratedProtocolMessageType('RunContext', (_message.Message,), {
  ...
  '__module__' : 'platforms.google.cirq_google.api.v2.run_context_pb2'
