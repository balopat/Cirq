...
from cirq_google.api.v2.metrics_pb2 import (
    MetricsSnapshot as platforms___google___cirq_google___api___v2___metrics_pb2___MetricsSnapshot,
)

from cirq_google.api.v2.program_pb2 import (
    Arg as platforms___google___cirq_google___api___v2___program_pb2___Arg,
...
class CalibrationLayer(google___protobuf___message___Message):
    class ArgsEntry(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> platforms___google___cirq_google___api___v2___program_pb2___Arg: ...

        def __init__(self,
            key : typing___Optional[typing___Text] = None,
            value : typing___Optional[platforms___google___cirq_google___api___v2___program_pb2___Arg] = None,
            ) -> None: ...
        @classmethod
    ...
    @property
    def layer(self) -> platforms___google___cirq_google___api___v2___program_pb2___Program: ...

    @property
    def args(self) -> typing___MutableMapping[typing___Text, platforms___google___cirq_google___api___v2___program_pb2___Arg]: ...

    def __init__(self,
        calibration_type : typing___Optional[typing___Text] = None,
        layer : typing___Optional[platforms___google___cirq_google___api___v2___program_pb2___Program] = None,
        args : typing___Optional[typing___Mapping[typing___Text, platforms___google___cirq_google___api___v2___program_pb2___Arg]] = None,
        ) -> None: ...
    @classmethod
...
class CalibrationLayerResult(google___protobuf___message___Message):
    ...
    @property
    def metrics(self) -> platforms___google___cirq_google___api___v2___metrics_pb2___MetricsSnapshot: ...
    ...
    def __init__(self,
        ...
        metrics : typing___Optional[platforms___google___cirq_google___api___v2___metrics_pb2___MetricsSnapshot] = None,
