...
# source: platforms/google/cirq_google/api/v2/program.proto
...
Program = _reflection.GeneratedProtocolMessageType('Program', (_message.Message,), {
  'DESCRIPTOR' : _PROGRAM,
  '__module__' : 'platforms.google.cirq_google.api.v2.program_pb2'
