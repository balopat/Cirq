...
# source: platforms/google/cirq_google/api/v1/params.proto
...
ParameterSweep = _reflection.GeneratedProtocolMessageType('ParameterSweep', (_message.Message,), {
  ...
  '__module__' : 'platforms.google.cirq_google.api.v1.params_pb2'
