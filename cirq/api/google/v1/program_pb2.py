...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        cirq_dot_api_dot_google_dot_v1_dot_operations__pb2.DESCRIPTOR,
        cirq_dot_api_dot_google_dot_v1_dot_params__pb2.DESCRIPTOR,
    ])
...
_PROGRAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='operations',
            full_name='cirq.api.google.v1.Program.operations',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.api.google.v1.Program.parameter_sweeps',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_RUNCONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='parameter_sweeps',
            full_name='cirq.api.google.v1.RunContext.parameter_sweeps',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PARAMETERIZEDRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='params',
            full_name='cirq.api.google.v1.ParameterizedResult.params',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'cirq.api.google.v1.ParameterizedResult.measurement_results',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_MEASUREMENTKEY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.api.google.v1.MeasurementKey.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='qubits',
            full_name='cirq.api.google.v1.MeasurementKey.qubits',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SWEEPRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='repetitions',
            full_name='cirq.api.google.v1.SweepResult.repetitions',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.api.google.v1.SweepResult.measurement_keys',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.api.google.v1.SweepResult.parameterized_results',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_RESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sweep_results',
            full_name='cirq.api.google.v1.Result.sweep_results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROGRAM.fields_by_name[
    'operations'].message_type = cirq_dot_api_dot_google_dot_v1_dot_operations__pb2._OPERATION
_PROGRAM.fields_by_name[
    'parameter_sweeps'].message_type = cirq_dot_api_dot_google_dot_v1_dot_params__pb2._PARAMETERSWEEP
_RUNCONTEXT.fields_by_name[
    'parameter_sweeps'].message_type = cirq_dot_api_dot_google_dot_v1_dot_params__pb2._PARAMETERSWEEP
_PARAMETERIZEDRESULT.fields_by_name[
    'params'].message_type = cirq_dot_api_dot_google_dot_v1_dot_params__pb2._PARAMETERDICT
_MEASUREMENTKEY.fields_by_name[
    'qubits'].message_type = cirq_dot_api_dot_google_dot_v1_dot_operations__pb2._QUBIT
_SWEEPRESULT.fields_by_name['measurement_keys'].message_type = _MEASUREMENTKEY
_SWEEPRESULT.fields_by_name[
    'parameterized_results'].message_type = _PARAMETERIZEDRESULT
