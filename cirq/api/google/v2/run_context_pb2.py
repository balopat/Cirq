...
_SWEEPFUNCTION_FUNCTIONTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name='FUNCTION_TYPE_UNSPECIFIED',
                                        index=0,
                                        number=0,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='PRODUCT',
                                        index=1,
                                        number=1,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='ZIP',
                                        index=2,
                                        number=2,
                                        serialized_options=None,
                                        type=None),
...
_RUNCONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.api.google.v2.RunContext.parameter_sweeps',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PARAMETERSWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='repetitions',
            full_name='cirq.api.google.v2.ParameterSweep.repetitions',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='sweep',
            full_name='cirq.api.google.v2.ParameterSweep.sweep',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sweep_function',
            full_name='cirq.api.google.v2.Sweep.sweep_function',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='single_sweep',
            full_name='cirq.api.google.v2.Sweep.single_sweep',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extension_ranges=[],
    oneofs=[
        _descriptor.OneofDescriptor(name='sweep',
                                    full_name='cirq.api.google.v2.Sweep.sweep',
                                    index=0,
                                    containing_type=None,
                                    fields=[]),
    ],
...
_SWEEPFUNCTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='function_type',
            full_name='cirq.api.google.v2.SweepFunction.function_type',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='sweeps',
            full_name='cirq.api.google.v2.SweepFunction.sweeps',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SINGLESWEEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='parameter_key',
            full_name='cirq.api.google.v2.SingleSweep.parameter_key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='points',
            full_name='cirq.api.google.v2.SingleSweep.points',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='linspace',
            full_name='cirq.api.google.v2.SingleSweep.linspace',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='sweep',
            full_name='cirq.api.google.v2.SingleSweep.sweep',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_POINTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='points',
            full_name='cirq.api.google.v2.Points.points',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_LINSPACE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='first_point',
            full_name='cirq.api.google.v2.Linspace.first_point',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='last_point',
            full_name='cirq.api.google.v2.Linspace.last_point',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='num_points',
            full_name='cirq.api.google.v2.Linspace.num_points',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_SWEEP.fields_by_name[
    'sweep_function'].containing_oneof = _SWEEP.oneofs_by_name['sweep']
_SWEEP.oneofs_by_name['sweep'].fields.append(
    _SWEEP.fields_by_name['single_sweep'])
_SWEEP.fields_by_name['single_sweep'].containing_oneof = _SWEEP.oneofs_by_name[
    'sweep']
_SWEEPFUNCTION.fields_by_name[
    'function_type'].enum_type = _SWEEPFUNCTION_FUNCTIONTYPE
...
_SINGLESWEEP.fields_by_name[
    'points'].containing_oneof = _SINGLESWEEP.oneofs_by_name['sweep']
_SINGLESWEEP.oneofs_by_name['sweep'].fields.append(
    _SINGLESWEEP.fields_by_name['linspace'])
_SINGLESWEEP.fields_by_name[
    'linspace'].containing_oneof = _SINGLESWEEP.oneofs_by_name['sweep']
