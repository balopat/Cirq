...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        cirq_dot_api_dot_google_dot_v2_dot_program__pb2.DESCRIPTOR,
    ])
...
_RESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sweep_results',
            full_name='cirq.api.google.v2.Result.sweep_results',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SWEEPRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='repetitions',
            full_name='cirq.api.google.v2.SweepResult.repetitions',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='cirq.api.google.v2.SweepResult.parameterized_results',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PARAMETERIZEDRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='params',
            full_name='cirq.api.google.v2.ParameterizedResult.params',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'cirq.api.google.v2.ParameterizedResult.measurement_results',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MEASUREMENTRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.api.google.v2.MeasurementResult.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'cirq.api.google.v2.MeasurementResult.qubit_measurement_results',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_QUBITMEASUREMENTRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='qubit',
            full_name='cirq.api.google.v2.QubitMeasurementResult.qubit',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='results',
            full_name='cirq.api.google.v2.QubitMeasurementResult.results',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_PARAMETERDICT_ASSIGNMENTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='cirq.api.google.v2.ParameterDict.AssignmentsEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='cirq.api.google.v2.ParameterDict.AssignmentsEntry.value',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_PARAMETERDICT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='assignments',
            full_name='cirq.api.google.v2.ParameterDict.assignments',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _PARAMETERDICT_ASSIGNMENTSENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_PARAMETERIZEDRESULT.fields_by_name[
    'measurement_results'].message_type = _MEASUREMENTRESULT
_MEASUREMENTRESULT.fields_by_name[
    'qubit_measurement_results'].message_type = _QUBITMEASUREMENTRESULT
_QUBITMEASUREMENTRESULT.fields_by_name[
    'qubit'].message_type = cirq_dot_api_dot_google_dot_v2_dot_program__pb2._QUBIT
_PARAMETERDICT_ASSIGNMENTSENTRY.containing_type = _PARAMETERDICT
_PARAMETERDICT.fields_by_name[
    'assignments'].message_type = _PARAMETERDICT_ASSIGNMENTSENTRY
...
DESCRIPTOR.message_types_by_name[
    'QubitMeasurementResult'] = _QUBITMEASUREMENTRESULT
